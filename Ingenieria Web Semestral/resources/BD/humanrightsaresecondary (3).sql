...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2022 a las 01:05:09
...
--
-- Base de datos: `humanrightsaresecondary`
--
...
--
-- Volcado de datos para la tabla `jugadores_equipo`
--
...
(27, 19, 14, '0000-00-00 00:00:00', 0, 0, NULL, 'Finalizado', 'B', 2),
...
ALTER TABLE `partidos`
  ...
  ADD KEY `FK_partidos_equipos` (`id_equipo1`),
  ADD KEY `FK_partidos_equipos_2` (`id_equipo2`),
  ADD KEY `FK_partidos_equipos_3` (`id_equipo_ganador`),
  ADD KEY `FK_partidos_Grupo` (`grupo_p`),
...
ALTER TABLE `usuarios`
  ...
  ADD KEY `FK_usuarios_equipos` (`id_equipo_fav`);
...
--
-- AUTO_INCREMENT de la tabla `jugadores_equipo`
--
ALTER TABLE `jugadores_equipo`
  MODIFY `id_jugador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=609;

--
-- AUTO_INCREMENT de la tabla `partidos`
--
ALTER TABLE `partidos`
  MODIFY `id_partido` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
ALTER TABLE `equipos`
  ADD CONSTRAINT `fK_equipos_grupo` FOREIGN KEY (`grupo`) REFERENCES `grupos` (`grupo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `jugadores_equipo`
--
ALTER TABLE `jugadores_equipo`
  ADD CONSTRAINT `FK__equipos` FOREIGN KEY (`id_equipo`) REFERENCES `equipos` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `partidos`
--
ALTER TABLE `partidos`
  ADD CONSTRAINT `FK_partidos_equipos` FOREIGN KEY (`id_equipo1`) REFERENCES `equipos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_partidos_equipos_2` FOREIGN KEY (`id_equipo2`) REFERENCES `equipos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_partidos_equipos_3` FOREIGN KEY (`id_equipo_ganador`) REFERENCES `equipos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  ADD CONSTRAINT `FK_partidos_estadio` FOREIGN KEY (`estadio`) REFERENCES `estadios` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_partidos_grupo` FOREIGN KEY (`grupo_p`) REFERENCES `grupos` (`grupo`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `FK_usuarios_equipos` FOREIGN KEY (`id_equipo_fav`) REFERENCES `equipos` (`id`) ON DELETE SET NULL ON UPDATE CASCADE;
COMMIT;
