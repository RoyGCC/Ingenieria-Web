...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 21-11-2022 a las 23:42:02
...
(20, 3, 'ARABIA SAUDITA', 'ARABIA SAUDITA.gif'),
...
(311, 16, 'BRENNAN', 'BRENNAN.gif'),
(312, 16, 'JOHNSON', 'JOHNSON.gif'),
...
--
ALTER TABLE `jugadores_equipo`
  MODIFY `id_jugador` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=608;
